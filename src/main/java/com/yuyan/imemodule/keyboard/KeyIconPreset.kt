...
val keyIconRecords: Map<Int, Drawable?> = mapOf(
    ...
    Objects.hash(InputModeSwitcherManager.USER_DEF_KEYCODE_SHIFT_1, KeyEvent.META_SHIFT_ON) to ContextCompat.getDrawable(Launcher.instance.context, R.drawable.shift_on_1_icon),
    Objects.hash(InputModeSwitcherManager.USER_DEF_KEYCODE_SHIFT_1, KeyEvent.META_CAPS_LOCK_ON) to ContextCompat.getDrawable(Launcher.instance.context, R.drawable.shift_lock_2_icon),
    ...
    Objects.hash(InputModeSwitcherManager.USER_DEF_KEYCODE_SHIFT_1, KeyEvent.META_SHIFT_ON + 3) to ContextCompat.getDrawable(Launcher.instance.context, R.drawable.shift_on_4_icon),
    Objects.hash(InputModeSwitcherManager.USER_DEF_KEYCODE_SHIFT_1, KeyEvent.META_CAPS_LOCK_ON + 3) to ContextCompat.getDrawable(Launcher.instance.context, R.drawable.shift_lock_5_icon),
